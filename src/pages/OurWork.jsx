    ...
    <div>
      <section className="page-hero">
        <div className="container">
          ...
          <h1>Thoughtful planning. Professional delivery.</h1>
          <p>
      ...
      <section className="section">
        <div className="container">
          <div className="section-head">
            <div>
              <span className="eyebrow">Project Capabilities</span>
              <h2>Work that brings multiple details together.</h2>
            </div>
            <p>
              Our portfolio continues to grow across events, printing,
              travel, branding, marketing, and recognition initiatives.
            </p>
          </div>
      ...
      <section className="section soft">
        <div className="container two-col">
          <div>
            ...
            <h2>Every project begins with understanding the purpose.</h2>
          </div>
          <div>
            <p className="lead">
              We begin by understanding the client goals, audience, budget,
              timeline, and expected result.
            </p>
            <p>
              From there, we create a practical plan, coordinate the required
              services, manage suppliers and logistics, and maintain clear
        ...
        <div className="container">
          <div className="section-head">
            <div>
              ...
              <h2>A clear process from idea to completion.</h2>
            </div>
          </div>
          ...
          <div className="process-grid">
            <article>
              ...
              <h3>Understand</h3>
              <p>
                We listen to the purpose, requirements, timeline, audience,
            ...
            <article>
              ...
              <h3>Coordinate</h3>
              <p>
                We manage production, communication, logistics, suppliers,
                and project details.
              </p>
            </article>
            ...
            <article>
              ...
              <h3>Deliver</h3>
              <p>
                We complete the project professionally and provide support
      ...
      <section className="section award-band">
        <div className="container award-grid">
          <div>
            <span className="eyebrow gold">Featured Initiative</span>
            <h2>Global Authors Award 2026</h2>
            <p>
              A signature recognition initiative celebrating authors,
              literary achievement, creativity, and meaningful stories.
            </p>
            <div className="actions">
              <Link to="/global-authors-award" className="btn lime">
                View the Initiative
              </Link>
            </div>
          </div>
      ...
      <section className="section">
        <div className="container cta-simple">
          <div>
            <span className="eyebrow">Plan Your Next Project</span>
            <h2>Let us create something meaningful together.</h2>
          </div>

    ...
    <div>
      <section className="page-hero">
        <div className="container">
          <span className="eyebrow">Contact Infinity Services</span>
          <h1>Let us discuss your next project.</h1>
          <p>
            Tell us what you are planning, producing, promoting, printing,
            or coordinating. Our team will help organize the right solution.
          </p>
        </div>
      </section>
      ...
      <section className="section">
        <div className="container contact-layout">
          <div className="contact-details">
            ...
            <h2>One conversation can simplify the entire project.</h2>
            <p className="lead">
